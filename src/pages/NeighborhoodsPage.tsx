...
import { MapPin, Home, Wrench, DollarSign, TrendingUp, ArrowRight } from "lucide-react";
...
function neighborhoodColor(label: string): string {
  return NEIGHBORHOOD_COLORS[label.toLowerCase()] ?? "#22d3ee";
}
    ...
    <div className="page-container">
      ...
      {isLoading ? (
        ...
        <section className="page-section">
          ...
          <div className="neighborhoods-grid">
            {neighborhoods.map((n) => {
              const color = neighborhoodColor(n.label);
      ...
      <section className="page-section">
        <div className="glass-card">
          ...
          <p style={{ margin: "8px 0 0", color: "rgba(255,255,255,0.50)", fontSize: "0.82rem", lineHeight: 1.6 }}>
            Neighborhood boundaries in this app are defined by geographic coordinate ranges based on
            ...
            are derived from permit pressure scoring over a 5-year window.
          </p>
        </div>
      </section>
    </div>
