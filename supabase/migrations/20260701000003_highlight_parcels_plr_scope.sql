-- Add parcel_lot_relationships path to the subdivision scope in highlight_parcels.
-- Previously the subdivision scope only checked property_subdivision_links and
-- parcels.subdivision_id, missing the majority of parcels that are linked via
-- parcel_lot_relationships → gis_lots. This caused highlight reels on subdivision
-- pages to show only 1 property even when 30+ were linked.
