-- Spatial parcel assignment: finds all parcels whose centroid falls inside a
-- neighborhood's saved geometry and sets the appropriate FK column based on
-- neighborhood_type (official_planning, business_district, local_market).
-- Returns the count of parcels updated.
