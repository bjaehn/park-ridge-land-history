-- Revert deed-priority NOT IN subquery — it causes a statement timeout on the
-- subdivisions index page. The earliest_year_built field is display-only and
-- doesn't need deed-priority correctness; the simple union is fast enough.
